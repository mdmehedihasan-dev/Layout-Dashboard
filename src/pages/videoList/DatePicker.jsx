...
export default function DatePicker() {
  ...
  return (
    <section className="bg-white py-10 w-full md:w-48">
      <div className="relative" ref={datepickerRef}>
        <div className="relative flex items-center">
          ...
          <input
            ...
            className="w-full rounded-lg border border-[#e5eaf2] py-3 pl-[50px] pr-8 text-[#FF0000] focus:outline-none"
            value={updateInput()}
        ...
        {isOpen && (
          <div className="absolute mt-2 rounded-lg bg-white pt-5 z-50 md:right-10 w-[300px] md:w-[400px]">
            <div className="flex items-center justify-between px-5">
              ...
              <button
                id="nextMonth"
                className="rounded-md px-2 py-2 text-dark"
                onClick={() =>
                  setCurrentDate(
                    new Date(currentDate.setMonth(currentDate.getMonth() + 1))
                  )
            ...
            <div className="mt-5 flex justify-end space-x-2.5 border-t border-stroke p-5 dark:border-dark-3">
              <button
                id="cancelButton"
                className="rounded-lg px-5 py-2.5 text-base font-medium border-2 border-[#FF0000] text-[#FF0000]"
              ...
              <button
                id="applyButton"
                className="rounded-lg bg-primary px-5 py-2.5 text-base font-medium text-white bg-[#FF0000]"
                onClick={handleApply}
              >
                Apply
              </button>
